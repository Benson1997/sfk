...
mapkey('ad','Douban',()=>{
    //orwindow.open("https://www.hao123.com"); 
    window.location.href="https://book.douban.com/"; 
})
...
mapkey('as','Duxiu',()=>{
    //orwindow.open("https://www.hao123.com"); 
    window.location.href="https://book.duxiu.com/"; 
})
...
mapkey('sg', '#6 Search selected with Google in background tab', function() {
    searchSelectedWith('https://www.google.com/search?q=', true);
});
...
addSearchAlias('d', 'Douban', 'https://search.douban.com/book/subject_search?search_text=', 's', 'https://duckduckgo.com/ac/?q=', function(response) {
    var res = JSON.parse(response.text);
    return res.map(function(r){
        return r.phrase;
    });
...
addSearchAlias('s', 'Duxiu', 'https://book.duxiu.com/search?&ecode=utf-8&channel=search&Field=all&sw=', 's', 'https://duckduckgo.com/ac/?q=', function(response) {
    var res = JSON.parse(response.text);
    return res.map(function(r){
        return r.phrase;
    });
