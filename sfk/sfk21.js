...
addSearchAlias('s', 'Duxiu', 'https://libproxy.z.library.sh.cn/https/443/com/duxiu/book/yitlink/search?exp=0&allsw=&channel=search&bCon=&ecode=utf-8&Field=all&sw=', 's', 'https://duckduckgo.com/ac/?q=', function(response) {
    var res = JSON.parse(response.text);
    return res.map(function(r){
        return r.phrase;
    });
